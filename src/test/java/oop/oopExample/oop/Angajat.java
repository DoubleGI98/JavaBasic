...
public class Angajat extends Persoana implements AngajatInterface{
    ...
    public void infoAngajat(){
        ...
        System.out.println("Varsta angajatului " + getNume() + " este " + getVarsta() + " si are o experienta de " + experienta + " ani");
    }
    ...
    // Polimorfism dinamic -----> A treia implementare
    public void mananca(){
    ...
    public void primesteSalariu() {
        System.out.println("Angajatul primeste salariul odata pe luna");
    }
