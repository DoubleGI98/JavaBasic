...
public class Student extends Persoana implements StudentInterface{
    ...
    public void infoStudent(){
        ...
        System.out.println("Persoana " + getPrenume() + " are cursuri de " + cursuri);
        System.out.println("Varsta persoanei " + getNume() + ""+getPrenume() + " este "+ getVarsta() + " si are/nu are " + bursa);
    }
    ...
    // Polimorfism dinamic -----> A doua implementare
    public void mananca(){
    ...
    public void mergeLaSeminar() {
        System.out.println("Studentul merge la seminar");
    }
